...
export default function TopHeader() {
  return (
    <div style={{ backgroundColor: "#0d0d0d" }} className="flex justify-between items-center text-white p-4">
      {/* Centraliza o texto apenas em telas pequenas */}
      <div className="mx-6 w-full text-xs md:text-left text-center">
        <p>
          <strong style={{ color: "#977656" }}>ESTAMOS ABERTOS</strong> 7 DIAS NA SEMANA
        </p>
      </div>

      {/* Itens de endereço e telefone visíveis somente em telas médias ou maiores */}
